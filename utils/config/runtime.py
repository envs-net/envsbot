...
def _idlerpg_values(cfg: Mapping[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "CRITICAL_STRIKE_CHANCE": _to_float(item("critical_strike_chance", "idlerpg_critical_strike_chance", 0.10) or 0.10, 0.10),
        "ITEM_DROP_CHANCE": _to_float(item("item_drop_chance", "idlerpg_item_drop_chance", 0.12) or 0.12, 0.12),
