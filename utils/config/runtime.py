...
def _idlerpg_values(cfg: Mapping[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "EVENT_CHANCE": _to_float(item("event_chance", "idlerpg_event_chance", 0.01) or 0.01, 0.01),
        "ITEM_CHANCE": _to_float(item("item_chance", "idlerpg_item_chance", 0.20) or 0.20, 0.20),
        "BATTLE_EVENT_WEIGHT": _to_float(item("battle_event_weight", "idlerpg_battle_event_weight", 0.55) or 0.55, 0.55),
        "ITEM_EVENT_WEIGHT": _to_float(item("item_event_weight", "idlerpg_item_event_weight", 0.15) or 0.15, 0.15),
        "ALIGNMENT_EVENT_WEIGHT": _to_float(item("alignment_event_weight", "idlerpg_alignment_event_weight", 0.10) or 0.10, 0.10),
        "CRITICAL_STRIKE_CHANCE": _to_float(item("critical_strike_chance", "idlerpg_critical_strike_chance", 1 / 35) or (1 / 35), 1 / 35),
        "CRITICAL_STRIKE_CHANCE_GOOD": _to_float(item("critical_strike_chance_good", "idlerpg_critical_strike_chance_good", 1 / 50) or (1 / 50), 1 / 50),
        "CRITICAL_STRIKE_CHANCE_EVIL": _to_float(item("critical_strike_chance_evil", "idlerpg_critical_strike_chance_evil", 1 / 20) or (1 / 20), 1 / 20),
        "ITEM_DROP_CHANCE": _to_float(item("item_drop_chance", "idlerpg_item_drop_chance", 0.02) or 0.02, 0.02),
        "TEAM_BATTLE_EVENT_WEIGHT": _to_float(item("team_battle_event_weight", "idlerpg_team_battle_event_weight", 0.08) or 0.08, 0.08),
        ...
        "UNIQUE_ITEM_CHANCE": _to_float(item("unique_item_chance", "idlerpg_unique_item_chance", 0.025) or 0.025, 0.025),
        ...
        "ITEM_DAMAGE_EVENT_WEIGHT": _to_float(item("item_damage_event_weight", "idlerpg_item_damage_event_weight", 0.08) or 0.08, 0.08),
        "ITEM_STEAL_EVENT_WEIGHT": _to_float(item("item_steal_event_weight", "idlerpg_item_steal_event_weight", 0.04) or 0.04, 0.04),
        "LEVEL_BATTLE_CHANCE_BELOW_25": _to_float(item("level_battle_chance_below_25", "idlerpg_level_battle_chance_below_25", 0.25) or 0.25, 0.25),
        "LEVEL_BATTLE_CHANCE_AT_25": _to_float(item("level_battle_chance_at_25", "idlerpg_level_battle_chance_at_25", 1.0) or 1.0, 1.0),
