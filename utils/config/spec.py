...
CONFIG_FIELDS: dict[str, ConfigKeySpec] = {
    ...
    'translate_libretranslate_api_key': ConfigKeySpec(MISSING, 'TRANSLATE_LIBRETRANSLATE_API_KEY', str, allow_empty=True, section='Translate', description='Optional LibreTranslate API key. Configured API-key providers are tried before public fallbacks.', sensitive=True, sample=None),
    'translate_google_api_key': ConfigKeySpec(MISSING, 'TRANSLATE_GOOGLE_API_KEY', str, allow_empty=True, section='Translate', description='Optional Google Cloud Translation Basic v2 API key. When configured, the official authenticated API is preferred over public fallbacks.', sensitive=True, sample=None),
