...
CONFIG_FIELDS: dict[str, ConfigKeySpec] = {
    ...
    'translate_capabilities_refresh_seconds': ConfigKeySpec(3600, 'TRANSLATE_CAPABILITIES_REFRESH_SECONDS', (int, float), minimum=60, section='Translate', description='How often configured translation providers refresh their supported-language capability cache in the background. Fresh capabilities let envsbot skip providers that definitely cannot serve a requested language pair before sending translation text.'),
