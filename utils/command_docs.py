...
def _rss_notes() -> list[str]:
    return [
        ...
        "",
        f"RSS list and health output include the feed number and latest local article number. A visible number can be used instead of the URL in all single-feed delete forms. URL-based deletion and the aliases `{PREFIX}rss del`, `{PREFIX}rss remove`, and `{PREFIX}rss rm` remain supported.",
        "",
