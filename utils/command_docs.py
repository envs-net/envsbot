...
def _rss_notes() -> list[str]:
    return [
        ...
        "",
        "```text",
        f"{PREFIX}rss remove all <user-jid>",
        "```",
        "",
        ...
        "",
        f"RSS list and health output include the feed number and latest local article number. A visible number can be used instead of the URL when deleting a feed, for example `{PREFIX}rss delete 12`. URL-based deletion and all existing aliases remain supported.",
        "",
