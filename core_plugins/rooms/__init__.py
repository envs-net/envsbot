...
_EXPORTS_BY_PART = {'state': ['log', 'JOINED_ROOMS', '_LEAVING_ROOMS', '_DIRECT_INVITE_NS', '_MUC_USER_NS', '_WARNED_ROOM_PLUGIN_DEFAULT_KEYS', '_safe_get_plugin', '_safe_plugin_value', '_maybe_await_result', '_get_plugin_store', '_store_get_global', '_store_set_global', '_room_matches', '_plugin_cleanup_changed', '_plugin_hook_cleanup_changed', '_room_in_runtime_state', '_leave_runtime_room', 'room_status_get', 'room_status_set', 'room_status_delete', '_yes_no', '_room_diagnose_lines'], 'defaults': ['PLUGIN_META', 'INTERNAL_PLUGIN_DEFAULTS', 'PLUGIN_DEFAULTS', 'PLUGIN_STORE_CONFIG', 'ROOM_TOGGLE_STORES', '_normalize_room_plugin_default_name', '_coerce_room_plugin_default', 'get_room_plugin_defaults', '_cleanup_room_plugin_state'], 'permissions': ['_maybe_get_user_role', '_sender_has_room_affiliation', '_sender_can_manage_room_settings', 'bot_has_privilege'], 'invites': ['room_invites_enabled', 'room_invite_notify_target', 'room_invite_admin_rooms', '_room_invite_max_age_days', '_room_invite_is_expired', '_invite_inviter_from_attr', '_room_invite_reason_from_invite', '_room_invite_from_muc_plugin', '_room_invite_from_direct_plugin', 'extract_room_invite', 'setup_room_invites_db', 'load_pending_room_invites', '_store_pending_room_invite', '_delete_pending_room_invite', 'cleanup_expired_room_invites', 'cleanup_all_room_invites', '_notify_room_invite', 'handle_room_invite', 'on_room_invite_message', 'on_room_invite', '_join_invited_room', 'rooms_invite'], 'settings': ['_cleanup_room_toggle_state', 'set_room_control_defaults', '_handle_room_feature_toggle'], 'presence': ['_jid_bare', '_looks_like_room_jid', '_message_context_room', '_room_is_known', '_resolve_room_settings_target', 'is_nick_change', 'on_muc_presence', 'is_valid_muc_domain', 'is_valid_room_jid'], 'commands': ['cmd_room_plugins', 'cmd_room_setdefaults', 'cmd_room_diagnose', 'cmd_room_enable', 'cmd_room_disable', 'rooms_add', 'rooms_update', 'rooms_delete', 'rooms_list', 'rooms_join', 'rooms_leave', 'rooms_sync'], 'lifecycle': ['autojoin_rooms', 'reconcile_autojoin_rooms', 'room_join_health_loop', 'start_room_join_health_task', 'restart_tasks', 'on_ready', 'on_session_ready', 'on_load', 'on_unload']}
