...
_EXPORTS_BY_PART = {'config': ['PLUGIN_META', 'RSS_KEY', 'DEFAULT_POLL_INTERVAL', 'RSS_RETRY_INITIAL_DELAY', 'RSS_RETRY_BACKOFF_MULTIPLIER', 'MAX_BACKOFF_TIME', 'RSS_USER_AGENT', 'RSS_FETCH_TIMEOUT_SECONDS', 'RSS_MAX_REDIRECTS', 'RSS_MAX_READ_BYTES', 'ALLOW_PRIVATE_FETCH_URLS', 'RSS_LIST_PAGE_SIZE', 'RSS_MAX_ENTRIES_PER_POLL'], 'store': ['log', '_flush_user_store', 'get_rss_store', '_set_retry_state', '_apply_retry_state', '_reset_retry_state', '_retry_delay', '_sleep_for_retry', '_format_retry_status', '_reset_feed_retry', 'cleanup_room_state', 'get_runtime_state'], 'fetch': ['SIMILARITY_THRESHOLD', 'entry_get', 'html_to_text_with_links', '_should_include_description', '_extract_entry_link', '_generate_entry_id', '_get_entry_id', '_get_latest_entry_id', '_normalize_url', '_resolve_relative_url', '_get_feed_headers', 'get_feeds', 'save_feeds', '_fetch_feed_bytes', '_github_feed_hint', '_format_feed_fetch_error', '_is_expected_feed_fetch_error', '_log_feed_fetch_error', '_parsed_value', '_has_feed_metadata', '_validate_parsed_feed', 'fetch_feed', '_load_feed', '_update_feed', '_set_feed_field', '_update_feed_link', '_entry_is_new', '_post_entry_to_rooms', '_handle_fetch_error', '_handle_empty_feed', '_format_feed_list_item', '_filter_feeds_for_room', '_format_feed_list', '_handle_feed_recovery', '_maybe_update_feed_link', '_cancel_feed_task'], 'formatting': ['_build_rss_message', '_format_duration', '_post_new_entries'], 'commands': ['_command_prefix', '_room_for_feed_command', '_sender_is_global_rss_manager', '_sender_can_manage_rss_room', '_sender_can_manage_rss_globally', '_looks_like_room_arg', '_normalize_room_jid', '_now', '_read_limited_response', '_mapping_value', '_set_mapping_value', '_initialize_last_id', '_save_last_id', '_rss_list_usage', '_rss_list_page', '_initialize_missing_last_id', '_collect_new_entries', 'burst_recent_entries', 'rss_command', '_add_feed', '_delete_feed_everywhere', '_delete_feed_room', '_reset_all_feed_retries', '_del_feed'], 'tasks': ['CHECK_TASKS', 'rss_check_loop', 'ensure_task', 'restart_all_tasks', 'on_load', 'restart_tasks', 'on_unload']}
